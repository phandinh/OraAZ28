...
create tablespace data2023 datafile size 1m autoextend on next 10m;

create tablespace indx2023 datafile  size 1m autoextend on next 10m;

create tablespace data2024 datafile size 1m autoextend on next 10m;

create tablespace indx2024 datafile  size 1m autoextend on next 10m;
...
create tablespace data3 datafile '/u01/app/oracle/oradata/ORCL/CC5C01A97A924B63E05380BDA8C055CE/datafile/data3_02.dbf' size 10m autoextend on next 100m;
...
select * from dba_data_files where file_name like '%data3%';
